...
xi = [0 0 40 0 0 10 10 10 30 10 40 10 0 20 10 20 20 20 30 20 40 20 10 40 20 40 30 40];
...
dy( = 1/m(1) * (F13 + F14);
dy2 = 1/m(2) * (F25 + F26);
dy3 = 1/m(3) * (-F13 - F43 - F83 - F73);
dy4 = 1/m(4) * (-F14 + F43 + F48);
dy5 = 1/m(5) * (-F25 + F56 + F510);
dy6 = 1/m(6) * (-F26 - F56 - F116 - F106);
dy7 = 1/m(7) * (F73 - F87 + F712);
dy8 = 1/m(8) * (F83 - F48 + F87 + F89 + F812);
dy9 = 1/m(9) * (-F89 - F129 + F913 - F149 - F109);
dy10 = 1/m(10) * (-F510 + F106 + F109 + F1011 + F1014);
dy11 = 1/m(11) * (F116 - F1011 + F1114);
dy12 = 1/m(12) * (-F812 - F912 + F129 + F1213);
dy13 = 1/m(13) * (-F913 - F1213 - F1413 + P);
dy14 = 1/m(14) * (F149 - F1014 - F1114 + F1413);
